...
class SingleTodo extends Component {
  ...
  handleToggleDone = () =>
    this.handleModalYesNo({
      icon: 'edit',
      txt: this.state.isFinished
        ? this.placeholder.questionUnFinish
        : this.placeholder.questionFinish,
      trueCallback: this.state.isFinished
        ? this.setUnfinished
        : this.setFinished,
    });
  ...
  handleToggleDelete = () =>
    this.handleModalYesNo({
      ...
      txt: this.state.isDeleted
        ? this.placeholder.questionUnDelete
        : this.placeholder.questionDelete,
  ...
  render() {
    const { title, deadline, viewOnly, placeholder } = this.props;
    const { isDeadline, isFinished, isDeleted, countdown, openModalYesNo } =
      this.state;
    ...
    return (
      <Card
        className={`todo_element task ${isFinishedClass} ${isDeadlineClass} ${isDeletingClass} ${isViewOnlyClass}`}
      >
        <Card.Content>
        ...
        {!viewOnly && (
          <Button color={'teal'} onClick={this.handleToggleDone}>
            <Icon
              name={(isFinished === true ? 'check ' : '') + 'square outline'}
            />
